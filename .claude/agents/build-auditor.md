...
- 3.9 Packages: docs/PACKAGES.md parseable, gnome-core-apps block fully commented out

Also verify the deliverable contract in CLAUDE.md section 4: complete replacement files only, push script present, companion directory complete, no unintended deletions.
