...
# 📜 MiOS Scripts Index
> **Generated:** 2026-04-27T03:13:44.053421
...
- **Description:** automation/05-enable-external-repos.sh

## `08-system-files-overlay.sh`
- **Path:** `automation/08-system-files-overlay.sh`
- **Description:** automation/08-system-files-overlay.sh - MiOS v2.1.0
...
- **Description:** automation/35-gpu-pv-shim.sh - MiOS v2.1.0
...
- **Description:** automation/36-akmod-guards.sh - MiOS v2.1.0
...
- **Description:** automation/42-cosign-policy.sh - MiOS v2.6.3
