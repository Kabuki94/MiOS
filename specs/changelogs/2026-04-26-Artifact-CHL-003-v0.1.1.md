...
- **RTX 50-series VFIO reset bug**: Detection in GPU auto-detect service, user [WARN] at boot, documentation at `/usr/share/doc/mios-vfio-[WARN].txt`
- **NVIDIA open kernel modules**: `nvidia-open.conf` modprobe config for Turing+ default
- **New tool**: `mios-vfio-check` validates IOMMU, vfio modules, NVIDIA GPU detection, RTX 50 [WARN]
...
- **Pinned version**: v0.1.3+k3s1 for reproducible builds
...
|------|--------|-------------|
| VERSION | Modified | v0.1.3  v0.1.3 |
...
| automation/10-gnome.sh | Modified | GNOME 49+ systemd notes, Bibata v0.1.3, Flatseal |
| automation/11-hardware.sh | Modified | NVIDIA open modules, RTX 50 [WARN] |
