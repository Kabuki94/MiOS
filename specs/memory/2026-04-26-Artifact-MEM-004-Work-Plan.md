...
### T2.5  Add bootc bash completion to Containerfile  [OK] DONE
**File:** `Containerfile`
...
### T2.6  Implement SBOM generation (CycloneDX/SPDX) [OK] DONE
...
### T3.2  Update .env and Repository Metadata [OK] DONE
...
|------|----------------|
| `osautomation/bootc-image-builder-action@v0.1.3` migration | Current `ublue-os` action still works; migration is non-trivial and needs testing |
