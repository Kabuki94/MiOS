...
Dual-agent persistent memory.

1. **Claude OS**: Persistent architectural memory.
2. **Google Gemini**: implementation and reasoning harness.
3. **MCP Server**: Local knowledge retrieval on port 8051.
