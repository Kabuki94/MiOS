...
- Add `LoginTo = false` to `system_files/usr/lib/cockpit/cockpit.conf` to neutralize CVE-2026-4631 until F44 rebase delivers Cockpit ≥ 360
...
- Monitor ublue-os/cayo for MiOS-3 base migration candidacy
