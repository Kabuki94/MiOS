...
# === CONFIGURATION FILES ===
COPY system_files/etc/modules-load.d/ceph.conf /etc/modules-load.d/ceph.conf
COPY system_files/etc/rancher/k3s/config.yaml /etc/rancher/k3s/config.yaml
COPY system_files/etc/systemd/system/var-home.mount /etc/systemd/system/
COPY system_files/etc/systemd/system/var-lib-containers.mount /etc/systemd/system/
COPY system_files/etc/systemd/system/ceph-bootstrap.service /etc/systemd/system/
COPY system_files/usr/local/bin/ceph-bootstrap.sh /usr/local/bin/ceph-bootstrap.sh

# === SYSTEMD UNITS ===
COPY system_files/usr/lib/systemd/system/k3s.service /usr/lib/systemd/system/
...
### system_files/ directory additions
