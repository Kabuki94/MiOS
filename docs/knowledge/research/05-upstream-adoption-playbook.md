...
- `system_files/desktop/shared/usr/lib/systemd/system/bazzite-libvirtd-setup.service`: pattern for first-boot libvirt enablement (ConditionPathExists, restorecon, state-file). Clone verbatim for MiOS libvirt setup.
