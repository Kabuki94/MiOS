...
| Finding | MiOS Action |
|---------|---------------|
| `ublue-os/bootc-image-builder-action` is in maintenance mode; upstream is `osbuild/bootc-image-builder-action@v2.1.0` | Evaluate migration — note in research doc; do not rush |
