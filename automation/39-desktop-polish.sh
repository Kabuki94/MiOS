#!/bin/bash
# MiOS v0.1.3  39-desktop-polish: Desktop entries, Cockpit webapp, MOTD
#
# CHANGELOG v0.1.3:
...
# === COCKPIT DESKTOP ENTRY  uses cockpit-desktop (no TLS [WARN]s) ===
...
# === MOTD DASHBOARD ===
# v0.1.3: ARCHITECTURAL PURITY FIX. The MOTD script is now delivered via the
