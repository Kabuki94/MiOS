...
|---|---|---|
| `docs/core/` | Architectural Blueprints & Manifests | `docs/manifest.json` |
| `docs/engineering/` | Technical SSOTs (Packages, Scripts) | `docs/manifest.json` |
| `docs/knowledge/research/`| Upstream Deep-Dives & Research | `docs/manifest.json` |
| `docs/knowledge/guides/` | Operational Procedures | `docs/manifest.json` |
| `scripts/` | Build & Configuration Automation | `scripts/manifest.json` |
| `system_files/` | Root Filesystem Overlay | `system_files/manifest.json` |
| `artifacts/` | Build Metadata & RAG Snapshots | `artifacts/manifest.json.gz` |
| `.claude/memories/` | Shared AI Journal & Brain | `.claude/memories/manifest.json` |
...
2. **Journaling:** Append every significant action/discovery to `.claude/memories/journal.md` using the [MiOS Journaling Protocol](docs/knowledge/research/2026-04-26-Artifact-KBX-022-AI-RESEARCH-TEMPLATE.md).
...
- **Target: bootc/fedora-bootc**
  - Priority Docs: `docs/knowledge/research/2026-04-26-Artifact-KBX-01-bootc-ecosystem-advances-2025-2026.md`
  - Pattern: Focus on "USR-OVER-ETC" and "NO-MKDIR-IN-VAR" laws.
- **Target: NVIDIA/GPU Passthrough**
  - Priority Docs: `docs/knowledge/research/2026-04-26-Artifact-KBX-10-vfio-gpu-passthrough-fedora-2025.md`
