...
#  Version: v2.1.0 - Complete Integrated Edition
#
...
#==============================================================================
readonly MIOS_VERSION="v2.1.0"
readonly MIOS_NAME="Cloud-WS Unified Management System"
...
handle_cli_args() {
    case "${1:-}" in
        ...
        help|-h|--help)
            ...
            ;;
        version|-v|--version)
            echo "Cloud-WS Unified Management System v$MIOS_VERSION"
            echo "$MIOS_CODENAME"
            ;;
        "")
            # Interactive mode
