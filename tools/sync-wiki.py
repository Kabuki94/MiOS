...
def sync_json_embeds(file_path):
    ...
    content = re.sub(r"# [NET] MiOS: Immutable Cloud-Native Workstation\n\n```json\n(.*?)\n```", 
                     r"# [NET] MiOS: Immutable Cloud-Native Workstation\n\n```json\n\1\n```", content, flags=re.DOTALL)
...
def sync_wiki():
    ...
    content = f"""<!-- [NET] MiOS Artifact | Proprietor: MiOS-DEV | https://github.com/Kabuki94/MiOS-bootstrap -->
...
"""
    ...
    content += "<!--  MiOS Proprietary Artifact | Copyright (c) 2026 MiOS-DEV -->"
