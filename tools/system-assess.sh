#!/usr/bin/env bash
#
# system-assess.sh - Comprehensive System Layout/Hardware/Topology Assessment
# Outputs detailed system information to a file in user's home directory
#
...
if [[ "${1:-}" == "-h" || "${1:-}" == "--help" ]]; then
    ...
    echo ""
    echo "Comprehensive system assessment for hardware, topology, IOMMU, VFIO, and passthrough."
    echo ""
    echo "Arguments:"
