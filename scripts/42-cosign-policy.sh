#!/usr/bin/env bash
# ============================================================================
# scripts/42-cosign-policy.sh - MiOS v2.1.0
# ----------------------------------------------------------------------------
# Consolidates cosign binary installation, Sigstore trust roots, and policy.json.
# Supercedes 37-cosign-policy.sh.
#
# Note: we pin to v2.1.0 because v3 breaks rpm-ostree bundle format (OCI 1.1).
# ============================================================================
set -euo pipefail
...
if ! command -v cosign >/dev/null 2>&1; then
    log "  downloading cosign v2.1.0 static binary..."
    scurl "https://github.com/sigstore/cosign/releases/download/v2.1.0/cosign-linux-amd64" -o /usr/local/bin/cosign
...
# v2.1.0: Moved from etc/ to usr/lib/ in system_files
